...
// RASTGELE SORU GETİREN WEB SERVİS
// LİMİT parametresi zorunlu
...
/* SELECT * FROM questions where lecture_id=1  
ORDER BY RAND()  
LIMIT 10 */
...
$quantity = input_validator($_GET["limit"]);
    $sql = "SELECT * FROM questions where lecture_id='$lecture_id' ORDER BY RAND() LIMIT $quantity";
