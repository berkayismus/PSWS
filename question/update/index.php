...
$message = new Message();
// question_id ve diğer parametler boş gelmezse
if(!empty($_POST["question_id"]) && !empty($_POST["question_question"]) && !empty($_POST["question_answers"]) && !empty($_POST["question_validate_answer"])){
